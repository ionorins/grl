...
def parse_argument():
    parser = argparse.ArgumentParser(
        description='pytorch version of GraphSAGE')
    # data options
    ...
    parser.add_argument('--detect_strategy', type=str,
                        default='bfs')  # 'simple' / 'bfs'
    parser.add_argument('--new_ratio', type=float, default=0.0)

    parser.add_argument('--memory_size', type=int, default=0)
    parser.add_argument('--memory_strategy', type=str,
                        default='class')   # 'random' / 'class'
    ...
    parser.add_argument('--gnn_type', default='gat',
                        choices=['gat', 'sage', 'gcn', 'gatv2', 'supergat'])
    parser.add_argument('--heads', type=int, default=1)
    parser.add_argument('--sampler', default='rand',
                        choices=['rand', 'att', 'randatt'])
